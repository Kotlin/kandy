...
4. Run the [update_ws_resources.py](update_ws_resources.py) with 2 arguments - path to resource folder and path 
to Writerside shadowed topic with all resources (this is need to be done to add resouces to WS artifact).
   ```bash
