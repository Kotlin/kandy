...
class Histogram : SampleHelper("histogram") {
    ...
    @Test
    fun histogram_simple_dataframeCompilerPlugin() {
        // SampleStart
        val random = java.util.Random(42)
        val dataframe = dataFrameOf(
            "sample" to List(1000) { random.nextGaussian() }
    ...
    @Test
    fun histogram_settings_dataframeCompilerPlugin() {
        // SampleStart
        val experimentalData = dataFrameOf(
            "length" to columnOf(
                5.92, 6.44, 5.87, 4.99, 5.23,
    ...
    @Test
    fun histogram_grouped_dataframeCompilerPlugin() {
        // SampleStart
        val random = java.util.Random(42)
    ...
    @Test
    fun histogram_with_line_dataframeCompilerPlugin() {
        // SampleStart
        val random = java.util.Random(42)
