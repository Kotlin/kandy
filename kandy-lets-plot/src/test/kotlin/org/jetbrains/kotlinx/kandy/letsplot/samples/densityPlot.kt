...
class DensityPlot : SampleHelper("densityPlot") {
    ...
    @Test
    fun densityPlot_simple_dataframeCompilerPlugin() {
        // SampleStart
        val random = java.util.Random(42)
    ...
    @Test
    fun densityPlot_settings_dataframeCompilerPlugin() {
        // SampleStart
        val experimentalData = dataFrameOf(
            "length" to listOf(
                5.92, 6.44, 5.87, 4.99, 5.23,
    ...
    @Test
    fun densityPlot_grouped_dataframe() {
        // SampleStart
    ...
    @Test
    fun densityPlot_grouped_dataframeCompilerPlugin() {
        // SampleStart
        val macaqueWeights = listOf(
            1.563, 2.173, 2.118, 2.722, 2.384, 1.789, 2.649,
            1.299, 1.566, 1.821, 2.151, 1.554, 1.464, 1.611,
    ...
    @Test
    fun densityPlot_grouped_collections() {
        // SampleStart
        val macaqueWeights = listOf(
            1.563, 2.173, 2.118, 2.722, 2.384, 1.789, 2.649,
            1.299, 1.566, 1.821, 2.151, 1.554, 1.464, 1.611,
