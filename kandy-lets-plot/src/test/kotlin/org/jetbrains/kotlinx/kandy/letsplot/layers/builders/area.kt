...
class AreaTests {
    ...
    private lateinit var context: org.jetbrains.kotlinx.kandy.letsplot.layers.builders.AreaBuilder

    @BeforeTest
    fun setUp() {
        context = org.jetbrains.kotlinx.kandy.letsplot.layers.builders.AreaBuilder(parentContext)
    }
