...
class CrossbarTests {
    ...
    private lateinit var context: org.jetbrains.kotlinx.kandy.letsplot.layers.builders.CrossBarsBuilder

    @BeforeTest
    fun setUp() {
        context = org.jetbrains.kotlinx.kandy.letsplot.layers.builders.CrossBarsBuilder(parentContext)
    }
