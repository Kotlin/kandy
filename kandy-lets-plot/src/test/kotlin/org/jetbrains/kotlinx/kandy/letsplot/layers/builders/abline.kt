...
class ABLineTests {
    ...
    private lateinit var context: org.jetbrains.kotlinx.kandy.letsplot.layers.builders.ABLineBuilder

    @BeforeTest
    fun setUp() {
        context = org.jetbrains.kotlinx.kandy.letsplot.layers.builders.ABLineBuilder(parentContext)
    }
