...
public interface WithYMin : WithAes {
    ...
    public fun <T> yMin(column: ColumnReference<T>): PositionalMapping<T> {
        return bindingHandler.addPositionalMapping<T>(Y_MIN, column.name(), null)
    }
    ...
    public fun yMin(column: String): PositionalMapping<Any?> {
        return bindingHandler.addPositionalMapping(Y_MIN, column, null)
    }
    ...
    public fun <T> yMin(values: Iterable<T>): PositionalMapping<T> {
        return bindingHandler.addPositionalMapping<T>(Y_MIN, values.toList(), null, null)
    }
    ...
    public fun <T> yMin(values: DataColumn<T>): PositionalMapping<T> {
        return bindingHandler.addPositionalMapping<T>(Y_MIN, values, null)
    }
}