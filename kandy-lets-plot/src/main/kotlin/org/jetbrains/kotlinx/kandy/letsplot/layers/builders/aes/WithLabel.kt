...
public interface WithLabel : WithAes {
    ...
    public var label: String?
        get() = null
        set(value) {
            bindingHandler.addNonPositionalSetting(LABEL, value)
        }
    ...
    public fun <T> label(
        ...
        return bindingHandler.addNonPositionalMapping<T, String>(LABEL, column.name(), null)
    }
    ...
    public fun label(
        ...
        return bindingHandler.addNonPositionalMapping<Any?, String>(LABEL, column, null)
    }
    ...
    public fun <T> label(
        ...
        return bindingHandler.addNonPositionalMapping<T, String>(LABEL, values.toList(), name, null)
    }
    ...
    public fun <T> label(
        ...
        return bindingHandler.addNonPositionalMapping<T, String>(LABEL, values, null)
    }
}