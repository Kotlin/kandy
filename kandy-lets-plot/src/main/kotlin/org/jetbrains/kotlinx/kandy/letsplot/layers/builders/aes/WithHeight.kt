...
public interface WithHeight : WithAes {
    ...
    public var height: Double?
        get() = null
        set(value) {
            bindingHandler.addNonPositionalSetting(HEIGHT, value)
        }
    ...
    public fun <T> height(
        ...
        bindingHandler.addNonPositionalMapping<T, Double>(HEIGHT, column.name(), null)
    ...
    public fun height(column: String): NonPositionalMapping<Any?, Double> =
        bindingHandler.addNonPositionalMapping(HEIGHT, column, null)
    ...
    public fun <T> height(values: Iterable<T>, name: String? = null): NonPositionalMapping<T, Double> =
        bindingHandler.addNonPositionalMapping(HEIGHT, values.toList(), name, null)
    ...
    public fun <T> height(values: DataColumn<T>): PositionalMapping<T> =
        bindingHandler.addPositionalMapping(HEIGHT, values, null)
}