...
public class HLineContext(parent: LayerCollectorContext) : LayerContext(parent), WithYIntercept, WithAlpha, WithColor,
    WithWidthAsSize, WithType, WithXFree {
    override val requiredAes: Set<AesName> = setOf(Y_INTERCEPT)
    }
/*
