...
@PlotDslMarker
public class CrossBarContext(override var data: org.jetbrains.kotlinx.ggdsl.dsl.MutableNamedData) :
 ...
 */
public inline fun PlotContext.crossBar(block: CrossBarContext.() -> Unit) {
