...
@StatDSLMarker
public class BinContext(parent: LayerCollectorContextInterface, override val data: TableData): StatContext(parent) {
...
internal inline fun statBinImpl(
    ...
    BinContext(contextParent, newData).apply(block)
}
