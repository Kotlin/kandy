...
//    internal var arraySize: List<Int>? = null // TODO
    ...
    public companion object {
        ...
        public fun fromUrl(url: String, size: Double? = null, rotate: Int? = null): Symbol = Symbol("image://$url", size, rotate)

        public fun fromUrl(url: URL, size: Double? = null, rotate: Int? = null): Symbol = Symbol("image://$url", size, rotate)

        public fun fromUrl(url: URI, size: Double? = null, rotate: Int? = null): Symbol = Symbol("image://$url", size, rotate)

        public fun fromPath(path: String, size: Double? = null, rotate: Int? = null): Symbol = Symbol("path://$path", size, rotate)
    }
